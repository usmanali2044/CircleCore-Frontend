                ...
                <div className={`mb-6 transition-all duration-700 delay-100 ${mounted ? 'opacity-100 scale-100' : 'opacity-0 scale-90'}`}>
                    <div className="relative">
                        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-warm-yellow via-amber-300 to-warm-yellow-hover shadow-lg flex items-center justify-center">
                            <KeyRound className="w-7 h-7 text-ink" strokeWidth={2} />
                        </div>
                        ...
                        {submitted ? (
                            ...
                            <div className="text-center py-4 animate-scale-in">
                                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-success/10 flex items-center justify-center">
                                    <Send className="w-7 h-7 text-success" strokeWidth={2} />
                                </div>
                                ...
                                <p className="text-xs text-muted mt-3">
                                    ...
                                    <button
                                        onClick={() => { setSubmitted(false); clearError(); }}
                                        className="text-ink font-semibold underline underline-offset-4 decoration-warm-yellow decoration-2 ml-1 cursor-pointer"
                                    >
                                        try again
                                    </button>
                                </p>
